...
base_rul <- "https://api.nytimes.com/svc/movies/v2/"
endpoint <- "reviews/search.json"
uri <- paste0(base_rul, endpoint)

query_params_list <- list("api-key" = my_apikey, "movie_name" = movie_name)
...
# Print out the list.
list(recent_review$headline, recent_review$summary_short, recent_review$link.url)
